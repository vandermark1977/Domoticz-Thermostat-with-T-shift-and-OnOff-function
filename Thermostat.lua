return {
   on = {
    ...
    execute = function(domoticz, item)
        ...
        local ShiftManual = domoticz.devices(149)   -- Fill in IDX of Your Manual TaShift. If you don't use my Slowstart script(Check the readme.md), Fill in the normal Shift IDX
